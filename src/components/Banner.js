...
const Banner = () => {
  ...
  return (
    <section
      className="py-8 md:py-16 lg:py-24 min-h-[85vh] lg:min-h-[78vh] flex items-center"
      id="home"
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col gap-y-4 lg:flex-row lg:items-center lg:gap-x-12">
          <div className="flex-1 text-center font-secondary lg:text-left">
            ...
            >
              Hi, I'm Ayush, a passionate Full-Stack Developer with 4 years of
              experience building robust web and mobile applications. I
              specialize in turning complex requirements into clean, scalable,
              and efficient code, delivering exceptional user experiences. My
              expertise spans both frontend and backend technologies, allowing
              me to craft end-to-end solutions that are maintainable and
              performance-driven. I thrive on solving challenging problems and
              continuously learning to implement modern technologies
              effectively.
            </motion.p>
            ...
            >
              ...
              <a
                href="#"
                className="text-gradient btn-link text-sm lg:text-base"
              >
